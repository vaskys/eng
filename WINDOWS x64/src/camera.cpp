...
void Camera::set_zNear(float near_i)
{
    this->zNear=near_i;
}
...
glm::mat4 Camera::get_ortho_from_per() {
  glm::mat4 o =  glm::ortho(-10.0f,10.0f,-10.0f,10.0f,zNear,zFar);
  return o;
}


void Camera::set_yp(float y,float p) {
  yaw = y;
  pitch = p;
}
