...
void Material::set_color_specular_power(float s) {
  color_specular_power = s;
}

float Material::get_color_specular_power() {
  return color_specular_power;
}
